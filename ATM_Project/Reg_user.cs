...
namespace ATM_Project
{
    ...
    {
        static string conStr = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=BankDB;Data Source=LAPTOP-UK1UABRN\SQLEXPRESS"; // sua data source của anh em o day nhe
